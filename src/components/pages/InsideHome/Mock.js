    ...
    return (
        <div className="h-[48rem] min-h-max py-2 px-3 flex flex-col justify-center my-1 mx-9 bg-red-50 rounded-3xl">
            <div className="w-[42%] ml-[3rem]">
                ...
                <p className="mb-10">lorel fjnasoifbasobf oasdijfnaijfnai isdfnaniugnfpiua gadsifnisughpiu afisuisufanpiwefhapi fiasnhehiupefifuen aijfniwuefop9if aifnwiuefnipf aoifnewiufnwuif aweifunaiuwf ewfjaweiufnawefi awiefubawepf wiefubawipf pu</p>
                ...
                <div className="flex my-10 items-center">
                    ...
                    <p className="pl-2">Try Free for 14 days, No credit card required.</p>
                </div>
                <div className="flex my-10 items-center">
                    {/* <span className="text-[#fff] bg-black p-[2px] px-[10px] cursor-pointer rounded-[50%]">i</span> */}
                    <span className="text-[#fff] bg-black px-[10px] cursor-pointer rounded-[50%]">i</span>
                    <p className="pl-2">By signing up you agree to ouy <b className="underline ">terms</b> and <b className="underline ">privacy policy.</b></p>
                </div>
            </div>
        </div>
    );
