                ...
                <div>
                    ...
                    <form>
                        <div className="flex flex-col items-center w-full">
                            ...
                            <button className='flex items-center text-white justify-center m-3 px-8' style={{ background: 'linear-gradient(45deg, #2ed8b6, #59e0c5)', opacity: '0.8', borderColor: '#4099ff', padding: '10px', fontSize: '15px', borderRadius: '12px' }}>Mark Manual Attendance</button>
                        </div>
                    </form>
                </div>
