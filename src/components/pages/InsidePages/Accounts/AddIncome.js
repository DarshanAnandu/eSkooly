    ...
    <div className='m-9 w-full flex justify-center'>
      <div className='wid-stu-adding'>
        ...
        <form className='flex flex-col'>
          <input type='date' name='incomedate' value={formData.date} onChange={(e) =>handleChange(e)} placeholder='' className='bod-in my-1 mt-3 p-2 focus:outline-blue-500' required />
          <input type='text' name='description' value={formData.description} onChange={(e) =>handleChange} placeholder='Income Description' className='bod-in my-1 p-2 focus:outline-blue-500' required />
          <input type='text' name='amount' value={formData.amount} onChange={(e) =>handleChange} placeholder='Income Amount' className='bod-in my-1 p-2 focus:outline-blue-500' required />
          <hr className='mt-4' />
