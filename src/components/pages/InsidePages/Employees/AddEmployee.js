                ...
                <div className='disp-stu-adding my-1 mb-3'>
                    ...
                    <div className='wid-stu-adding mx-2' style={{ marginTop: '-10px' }}>
                        <div class="relative flex items-center my-3">
                            ...
                            <input type="text" value={formData.registrationNo} onChange={handleChange} placeholder="Registration No:"
                                class="bod-sin p-2 bg-white text-black w-full text-sm border-2 rounded outline-none" />
                        </div>
                        <label className='flex flex-col mb-3' style={{ marginTop: '-10px' }}>Joining Date: <input type='date' value={formData.joiningDate} onChange={handleChange} className='p-2 bod-in focus:outline-blue-500' /></label>
                    </div>
                    <div className='wid-stu-adding mx-2 flex flex-col'>
                        <select className='p-2 mb-2 bod-in' value={formData.employeeType} onChange={handleChange} required>
                            <option>----Employee Type----</option>
                        </select>
                        <input type='number' placeholder='Monthly Salary' value={formData.monthlySalary} onChange={handleChange} className='p-2 bod-in' />
              ...
              <input type='tel' placeholder='Mobile No: e.g +44xxxxxxxxxx' className='p-2 bod-in' name='Gphone' /> */}
                ...
                <div className='disp-stu-adding'>
                    <div className='wid-stu-adding mx-2'>
                        <input type='text' name='fnam' value={formData.fatherName} onChange={handleChange} placeholder='Name of Father' className='outline-black bod-in p-2 my-2 focus:outline-blue-500 w-full mb2' />
                        ...
                        <input type='text' name='edu' value={formData.education} onChange={handleChange} placeholder='Education' className='outline-black bod-in p-2 my-2 focus:outline-blue-500 w-full mb2' />
                    </div>
                    <div className='wid-stu-adding flex flex-col mx-2 mt-1'>
                        <select className='p-2 w-full my-2 bod-in' value={formData.gender} onChange={handleChange} required>
                            <option>Gender</option>
                            <option>Male</option>
                            <option>Female</option>
                        </select>
                        <select className='p-2 w-full my-2 bod-in' value={formData.religion} onChange={handleChange} name='religion' required>
                            <option>Religion</option>
                            <option>Hinduisiam</option>
                            <option>Islam</option>
                        </select>
                        <select className='p-2 w-full my-2 bod-in' value={formData.bloodGroup} onChange={handleChange} required>
                    ...
                    <div>
                        ...
                        <div className="relative flex items-center my-3">
                            ...
                            <input type='date' className='my-2 bod-in bod-sin p-2 bg-white text-black w-full text-sm border-2 rounded outline-none' value={formData.dateOfBirth} onChange={handleChange} placeholder='dd-mm-yyyy' />
                        </div>
                    </div>
                </div>
                <div className='disp-stu-adding mb-5'>
                    <div className='w-2/3 addr'>
                        <input type='text' name='addrss' value={formData.address} onChange={handleChange} placeholder='Address' className='outline-black p-2 bod-in my-2 w-11/12 addr focus:outline-blue-500' />
                    </div>
